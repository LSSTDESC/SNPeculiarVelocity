...
For example, 
over the course of a decade an LSST SN survey can produce find 4--14\% uncertainties in $fD$ in $0.05$ redshift bins from $z=0$ to 0.3, cumulatively giving
...
the  rest-frame volumetric SN~Ia rate is $\phi=7.84\times 10^{-5} h^3$\,Mpc$^{-3}$\,yr$^{-1}$.
...
The observing strategy of the imaging survey thus has a trade between  the solid angle ($\Omega$) monitored and  the light-curve quality ($\sigma_M$) generated.
...
For example, infrared data \citep{2012MNRAS.425.1007B} or spectrophotometry at peak brightness
 ...
 low-redshift sources are most valuable and the finite amount of follow-up should be spent on saturating redshifts lower than $z_{max}$.
 \end{itemize}
