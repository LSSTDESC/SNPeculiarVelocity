...
\textbf{Endorsers:}
Behzad Ansarinejad$^{1}$, 
Robert Armstrong$^{2}$, 
Jacobo Asorey$^{3}$, 
Carlo Baccigalupi$^{4,5,6}$, 
Maciej Bilicki$^{7}$, 
Julian Borrill$^{8}$, 
Elizabeth Buckley-Geer$^{9}$, 
Tamara M Davis$^{10}$, 
Kelly A. Douglass$^{11}$, 
Cora Dvorkin$^{12}$, 
Simone Ferraro$^{8}$, 
Simon Foreman$^{13}$, 
Llu\'is Galbany$^{14}$, 
Juan Garc\'ia-Bellido$^{15}$, 
Juan Garc\'ia-Bellido$^{16}$, 
Martina Gerbino$^{17}$, 
Mandeep S.S. Gill$^{18,19,20}$, 
Larry Gladney$^{21}$, 
Satya {Gontcho A Gontcho}$^{11}$, 
Julien Guy$^{8}$, 
Ren\'ee Hlo\v{z}ek$^{22,23}$, 
Dragan Huterer$^{24}$, 
Saurabh W.~Jha$^{25}$, 
Johann Cohen-Tanugi$^{26}$, 
D.\ O.\ Jones$^{27}$, 
Marc Kamionkowski$^{28}$, 
Ryan E. Keeley$^{3}$, 
Robert Kehoe$^{29}$, 
Savvas M. Koushiappas$^{30}$, 
Ely D.~Kovetz$^{31}$, 
Kazuya Koyama$^{32}$, 
Benjamin L'Huillier$^{3}$, 
Ofer Lahav$^{33}$, 
Chien-Hsiu Lee$^{34}$, 
Michele Liguori$^{35}$, 
Axel de la Macorra$^{36}$, 
Patrick McDonald$^{8}$, 
Joel Meyers$^{29}$, 
Mickael Rigault$^{37}$, 
Surhud More$^{38}$, 
...
Gustavo Niz$^{39}$, 
Antonella Palmese$^{9}$, 
Francesco Piacentini$^{40}$, 
Francesco Piacentni$^{40,41}$, 
Steven Rodney$^{42}$, 
Benjamin Rose$^{43}$, 
Masao Sako$^{44}$, 
Lado Samushia$^{45}$, 
Neelima Sehgal$^{46}$, 
Leonardo Senatore$^{18}$, 
Arman Shafieloo$^{3}$, 
Sara Simon$^{24}$, 
An\v{z}e Slosar$^{47}$, 
Stephanie Escoffier$^{48}$, 
Scott Watson$^{49}$, 
Martin White$^{50,8}$, 
Weishuang Xu$^{12}$, 
Gong-Bo Zhao$^{51,32}$, 
...
SNe~Ia discovered by ZTF \cite{2019PASP..131a8002B} over the next several years will provide first probative measures of $fD$ at $z<0.1$.
...
that is observed using current calibrations.  At this precision the intrinsic velocity dispersion  at $z=0.028$ is  of $300$~km\,s$^{-1}$, i.e.\ a single SN~Ia  is of such quality as to
...
\caption{Left: $|\partial \sigma_\gamma / \partial z|$  after two and ten years for a survey with limiting  depth $z_{\rm max}=0.2$. 
...
shorter surveys and those with higher $z_{\rm max}$) benefit more from extending the survey duration, as shown
n the right-panel plot of Figure~\ref{dvar:fig} that shows $\sigma_\gamma^{-1}|\partial \sigma_\gamma / \partial \ln{t}|$ as a function of
...
has a similar relationship with $\sigma_\gamma$ as shown
in the left-panel plot of $\sigma_\gamma^{-1}\partial \sigma_\gamma/\partial \sigma_M$  of Figure~\ref{dvar:fig}.\newline
