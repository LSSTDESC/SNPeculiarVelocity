...
Survey performance is examined in more detail by considering how $\sigma_\gamma$ changes with respect to the 
...
Figure~\ref{dvar:fig} shows $\partial \sigma_\gamma / \partial z$  for two- and ten-year surveys with limiting $z_{max}=0.2$.
...
\begin{figure}
\centering
\includegraphics[width=0.5\textwidth]{src/dvardz.png}
%\includegraphics[width=0.47\textwidth]{src/dvardlnt.png}
%\includegraphics[width=0.5\textwidth]{../outcosmo/zmax_.png}
\caption{$\partial \sigma_\gamma / \partial z$  for two- and ten-year surveys with limiting $z_{max}=0.2$. 
\label{dvar:fig}}
\end{figure}
...
$z_{max} \sim 0.2$ as seen in Figure~\ref{var:fig}.
 ...
 in  Figure~\ref{var:fig}.   The left panel of Figure~\ref{dvar2:fig} shows $\partial \sigma_\gamma / \partial \ln{t}$ as a function of
...
\centering
\includegraphics[width=0.47\textwidth]{src/dvardlnt.png}
\includegraphics[width=0.47\textwidth]{src/dvardsigM.png}
%\includegraphics[width=0.5\textwidth]{../outcosmo/zmax_.png}
\caption{Left: $\partial \sigma_\gamma / \partial \ln{t}$  and Right: $\partial \sigma_\gamma / \partial \sigma_M$ as a function of
...
An important survey parameter that is not considered is cost.
