...
The uncertainty  $\sigma_\gamma$ of a survey depends on its solid angle $\Omega$, depth $r_{max}= \chi(z_{max})$, duration
...
{\bf SNe~Ia Need Precise Distances:} Cosmological redshifts are inferred from SN~Ia distances. Distances are calculated from multi-band light curves, redshifts (when available),
SN spectroscopic features, and
host-galaxy properties.
Distance uncertainties here have been characterized by $\sigma_M$,
...
broad wavelength coverage, and with spectral-feature measurements.  Historically surveys with 2 or 3 well-sampled optical light curves obtained $\sigma_M \approx 0.15$~mag,
...
Choices in survey design impact the precision obtained on $\gamma$.  SN~Ia peculiar velocity surveys are of the highest scientific
