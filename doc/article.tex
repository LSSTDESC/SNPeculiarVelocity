...
and the WALLABY+WNSHS surveys will obtain Tully-Fisher distances (based on the $\sim 0.48$~mag calibration of absolute magnitude based on the  HI 21cm line width)
...
hundreds of thousands; over the course of 10-years, LSST will find $\sim150,000$ $z<0.2$,  $\sim520,000$ $z<0.3$ SNe~Ia
 ...
 the 10-year SN~Ia survey will have
 a 29$\times$ reduction in shot-noise ($\sigma^2_M/n$) relative to the Fundamental Plane survey of TAIPAN.
...
is included and is important contributor to the $\gamma$ constraint.  ***Uniform sampling ***
...
from galaxy signal in  the spectroscopic transient classification if the spectrograph had sufficient resolution.  ***Check number and explain. ***  Alternatively, 
...
***
DESI and 4MOST will exist in the 2020 decade, (the former having been endorsed by Astro 2010), but at low redshift their constraints on fs8 will be limited by cosmic variance, Since these two redshifts surveys will cover most of the usable sky, they will saturate the RSD technique, making PVs the only way to improve on fs8 at low z. TAIPAN and DESI BGS will be able to measure FP distances for nearly all usable galaxies nearby, so at low z the FP PV technique will also saturate in the coming decade. Thus, SN PV will be the most powerful way to further constrain $\sigma_\gamma$. Moreover, SN PV directly benefits from DESI and 4MOST through the cross-correlation of the galaxy density and velocity fields, and the in the redshifts provided for many of the SN host galaxies.

t TAIPAN+(+4MOST)+DESI are *capable* of saturating the FP technique nearby. If 4MOST or DESI chose not to do FP or fail in the attempt, that is just more reason to do SN PVs! But I think it's a good idea for readers to know that SN PVs are needed even if 4MOST and DESI do the best job they can on FP, simply because one runs out of suitable nearby FP galaxies.
***
%\begin{comment}
\newpage
