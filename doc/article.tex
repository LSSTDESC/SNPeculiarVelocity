...
The precision in the determination of the combination $\lambda= f\sigma_8$ is estimated using the Fisher matrix.  To first order, 
$P_{vv} \propto (f\sigma_8)^2$.
...
Equating LSST discovery with having a meaningful peculiar velocity, $n$ is thus a non-tunable parameter.  This leaves
solid angle, redshift depth, and intrinsic magnitude dispersion as the important tunable parameters in the design of a peculiar velocity survey.
