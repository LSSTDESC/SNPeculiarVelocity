...
First note that the  rest-frame volumetric SN~Ia rate (full selection efficiency) is $7.84\times 10^{-5} h^3$\,Mpc$^{-3}$\,yr$^{-1}$;
...
sare shown in  Figure~\ref{power:fig}.  For all of these survey scenarios, the transition between sample variance and shot-noise equality 
occurs at a $k$ squarely within the $k$-range that carries the most signal.
