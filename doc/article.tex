...
shorter surveys and those with higher $z_{\rm max}$) benefit more from extending the survey duration,  shown as  $\sigma_\gamma^{-1}|\partial \sigma_\gamma / \partial \ln{t}|$ as a function of
