...
$f \equiv \frac{d\ln{D}}{d\ln{a}}$ is the linear growth rate with $a$ the scale factor  \citep{2006PhRvD..73l3526H,2011ApJ...741...67D}.\footnote{
...
in Figure~2 of  \citet{1475-7516-2013-04-031}.\footnote{Note that we prefer the notation $fD$ in place of $f\sigma_8$, which is commonly used in the literature.}
%
...
\caption{Volume-weighted peculiar velocity power spectrum $k^3P_{vv}(z=0)$ for $\mu=\cos{(\hat{k} \cdot \hat{r})}=1, 0.5$ (magenta, cyan)  where 
$\hat{r}$ is the line of sight, as predicted for General Relativity in the linear regime.
Overplotted are volume-weighted peculiar-velocity power-spectrum shot noise predictions (diagonal lines) for various observing parameters.  Red shows the shot noise expected from a 2-year LSST survey
...
direction-independent, neglecting the slight declination-dependence of SN-survey time windows.\footnote{Code used for the analysis in this article available
at \url{https://github.com/LSSTDESC/SNPeculiarVelocity/tree/master/doc/src}.}
