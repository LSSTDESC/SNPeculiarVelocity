...
{\bf Introduction:} In the late 1990's, Type~Ia supernovae (SNe~Ia) were used as distance probes to measure the homogeneous expansion history of the Universe.  The remarkable discovery
...
$f \equiv \frac{d\ln{D}}{d\ln{a}}$ is the linear growth rate with $a$ the scale factor  \cite{2006PhRvD..73l3526H,2011ApJ...741...67D}.
%\footnote{
...
$f \approx \Omega_M^\gamma$ with $\gamma=0.55, 0.42, 0.68$ respectively \cite[see][for a review of
...
in Figure~2 of  \cite{1475-7516-2013-04-031}. (Note that we prefer the notation $fD$ in place of $f\sigma_8$, which is commonly used in the literature.)
%
...
Peculiar velocity surveys have already been  used to measure $fD$, though not to a level where  gravity models can be precisely distinguished.
 \cite{2017MNRAS.471..839A} use 6dFGS peculiar velocities using the Fundamental Plane distances of elliptical galaxies, to estimate absolute magnitudes
 with
...
These surveys combined are projected to have 3\% $fD$ uncertainties \cite{2017MNRAS.464.2517H}.
...
$0<z<0.2$ most of the probative power comes from peculiar velocities and at higher redshifts from Redshift Space Distortions  \cite{2017ApJ...847..128H}.

%\section{Testing Gravity with Peculiar Velocity Surveys}
{\bf Testing Gravity with Peculiar Velocity Surveys:} While the growth rate $fD$ can be used to test several aspects of physics beyond the standard cosmological model (e.g.\ dark matter clustering, dark energy evolution), our scientific interest is in probing gravity,
...
\cite[there is an alternative approach using an estimator for the mean pairwise velocity][]{2011PhRvD..83d3004B}.
...
{\bf Conclusions:} In the next decade,
...
supernovae, we provide a formalism and code by which their scientific merits can be assessed and here sketch results for a range of options.
