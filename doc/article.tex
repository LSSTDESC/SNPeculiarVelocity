...
This is evident in the plot of $\sigma_\gamma^{-1}\partial \sigma_\gamma/\partial \sigma_M$ shown in the bottom-right panel of Figure~\ref{dvar:fig}.
 ...
 are Gaussian-distributed.  Changes in this scale engender changes in the $\gamma$ precision, as    $\sigma_\gamma^{-1}\partial \sigma_\gamma/\partial k_{max} = 0.0050$ at $k_{max}=0.1h$\,Mpc$^{-1}$
and is survey-independent.
 \end{description}
...
\item Role of the rolling search (e.g.\ LSST):
